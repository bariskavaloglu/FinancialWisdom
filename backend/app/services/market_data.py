...
BIST_30: list[str] = [
    ...
    "HALKB.IS", "ISCTR.IS", "KCHOL.IS", "KONTR.IS", "KRDMD.IS", "MGROS.IS", "ODAS.IS",  "OYAKC.IS",
...
BIST_100_EXTRA: list[str] = [
    ...
    "BAGFS.IS", "BANVT.IS", "BIOEN.IS", "BRISA.IS",
    "BRYAT.IS", "BUCIM.IS", "CCOLA.IS", "CEMTS.IS", "CIMSA.IS",
    "CLEBI.IS", "DOAS.IS",  "DOHOL.IS", "EGEEN.IS",     "ENJSA.IS", "ENKAI.IS", "FENER.IS", "GESAN.IS", "GLYHO.IS",
    "GOLTS.IS", "GRSEL.IS", "HEKTS.IS", "INDES.IS",     "ISGYO.IS", "JANTS.IS", "KAREL.IS", "KATMR.IS", "KAYSE.IS",
    "KLNMA.IS", "KMPUR.IS", "KONYA.IS", "KORDS.IS",
    "KTLEV.IS", "LOGO.IS",  "LRSHO.IS", "MAVI.IS",  "MEDTR.IS",
    "MPARK.IS", "NETAS.IS", "NTHOL.IS", "OTKAR.IS",
    "PARSN.IS", "PGSUS.IS", "PRKAB.IS", "QUAGR.IS", "RAYSG.IS",
    "RGYAS.IS", "RYSAS.IS", "SARKY.IS", "SELEC.IS", "SMRTG.IS",
    "SOKM.IS",  "SUMAS.IS", "TATGD.IS", "TKNSA.IS",
