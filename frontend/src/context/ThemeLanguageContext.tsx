...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'backtest.selectAssessment': 'Select Questionnaire',
    'backtest.selectYear':     'Select Year',
    'backtest.noAssessments':  'No questionnaire found',
    'backtest.noAssessmentsDesc': 'Complete the risk questionnaire first. A simulated portfolio will be built from your answers.',
    'backtest.simulationInfo': 'Simulation: portfolio is reconstructed from questionnaire answers as if they were submitted on the selected date.',
    'backtest.simulating':     'Building simulated portfolio…',
    'backtest.simulatedPortfolio': 'Simulated Portfolio',
    'backtest.asOfDate':       'As of date',
    'backtest.cumReturn':      'Cumulative return',
    'backtest.h1vsH2':         'H1 signal vs H2 actual',
    'backtest.validResult':    '{profile} profile · {year}',
    'backtest.resultGood':     'The simulated portfolio returned {ret} in H2 {year}. The H1 signal ({h1}) correctly anticipated the trend.',
    'backtest.resultOk':       'The simulated portfolio returned {ret} in H2 {year}. Positive but modest — H1 signal was {h1}.',
    'backtest.resultBad':      'The simulated portfolio returned {ret} in H2 {year}. H1 signal was {h1} — the period proved difficult.',
    'backtest.assetCol':       'Asset',
    'backtest.classCol':       'Class',
    'backtest.weightCol':      'Weight',
  ...
  tr: {
    ...
    'backtest.selectAssessment': 'Anket Seç',
    'backtest.selectYear':     'Yıl Seç',
    'backtest.noAssessments':  'Anket bulunamadı',
    'backtest.noAssessmentsDesc': 'Önce risk anketini doldurun. Cevaplarınızdan seçilen tarihe göre simüle edilmiş bir portföy oluşturulacak.',
    'backtest.simulationInfo': 'Simülasyon: anket cevaplarınız seçilen tarihte verilmiş gibi portföy yeniden inşa edilir.',
    'backtest.simulating':     'Simüle portföy oluşturuluyor…',
    'backtest.simulatedPortfolio': 'Simüle Portföy',
    'backtest.asOfDate':       'Simülasyon tarihi',
    'backtest.cumReturn':      'Kümülatif getiri',
    'backtest.h1vsH2':         'H1 sinyal vs H2 gerçek',
    'backtest.validResult':    '{profile} profil · {year}',
    'backtest.resultGood':     'Simüle portföy H2 {year}\'de {ret} getiri sağladı. H1 sinyali ({h1}) trendi doğru öngördü.',
    'backtest.resultOk':       'Simüle portföy H2 {year}\'de {ret} getiri sağladı. Pozitif ama mütevazı — H1 sinyali {h1} idi.',
    'backtest.resultBad':      'Simüle portföy H2 {year}\'de {ret} getiri sağladı. H1 sinyali {h1} idi — dönem zorlu geçti.',
    'backtest.assetCol':       'Varlık',
    'backtest.classCol':       'Sınıf',
    'backtest.weightCol':      'Ağırlık',
