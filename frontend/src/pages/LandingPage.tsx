    ...
    <div className="min-h-screen flex flex-col bg-stone-100 dark:bg-stone-950">
      ...
      <section className="flex-1 flex flex-col justify-center px-6 py-20 max-w-4xl mx-auto w-full">
        <div className="animate-slide-up space-y-6">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-stone-300 dark:border-stone-700 bg-white dark:bg-stone-900 text-stone-600 dark:text-stone-400 text-sm font-medium">
      ...
      {/* Footer */}
      <footer className="border-t border-stone-200 dark:border-stone-800 py-5 px-6">
